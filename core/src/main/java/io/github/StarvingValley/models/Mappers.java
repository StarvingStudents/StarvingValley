...
public class Mappers {
  ...
  public static final ComponentMapper<UnsyncedComponent> unsynced =
      ComponentMapper.getFor(UnsyncedComponent.class);
  public static final ComponentMapper<SyncComponent> sync =
      ComponentMapper.getFor(SyncComponent.class);
  ...
  public static final ComponentMapper<ActiveWorldEntityComponent> activeWorldEntity =
      ComponentMapper.getFor(ActiveWorldEntityComponent.class);
  public static final ComponentMapper<InputComponent> input =
      ComponentMapper.getFor(InputComponent.class);
  public static final ComponentMapper<ClickableComponent> clickable =
      ComponentMapper.getFor(ClickableComponent.class);
  public static final ComponentMapper<ClickedComponent> clicked =
      ComponentMapper.getFor(ClickedComponent.class);
  public static final ComponentMapper<DraggingComponent> dragging =
      ComponentMapper.getFor(DraggingComponent.class);
  public static final ComponentMapper<DragEndComponent> dragEnd =
      ComponentMapper.getFor(DragEndComponent.class);
  public static final ComponentMapper<SpriteComponent> sprite =
      ComponentMapper.getFor(SpriteComponent.class);
  public static final ComponentMapper<TextComponent> text =
  ...
  public static final ComponentMapper<TileOccupierComponent> tileOccupier =
  ...
  public static final ComponentMapper<SyncDeletionRequestComponent> syncDeletionRequest =
      ComponentMapper.getFor(SyncDeletionRequestComponent.class);
  ...
  public static final ComponentMapper<WorldMapFarmComponent> worldMapFarm =
      ComponentMapper.getFor(WorldMapFarmComponent.class);
  public static final ComponentMapper<ButtonComponent> button =
      ComponentMapper.getFor(ButtonComponent.class);
  public static final ComponentMapper<HudComponent> hud =
      ComponentMapper.getFor(HudComponent.class);
  public static final ComponentMapper<InventoryItemComponent> inventoryItem =
      ComponentMapper.getFor(InventoryItemComponent.class);
  public static final ComponentMapper<InventorySelectedItemComponent> inventorySelectedItem =
      ComponentMapper.getFor(InventorySelectedItemComponent.class);
  public static final ComponentMapper<FoodItemComponent> foodItem =
      ComponentMapper.getFor(FoodItemComponent.class);
  public static final ComponentMapper<TradingComponent> trading =
      ComponentMapper.getFor(TradingComponent.class);
  public static final ComponentMapper<EconomyComponent> economy =
      ComponentMapper.getFor(EconomyComponent.class);
  public static final ComponentMapper<InventoryComponent> inventory =
      ComponentMapper.getFor(InventoryComponent.class);
  public static final ComponentMapper<InventorySlotComponent> inventorySlot =
      ComponentMapper.getFor(InventorySlotComponent.class);
  public static final ComponentMapper<HotbarComponent> hotbar =
      ComponentMapper.getFor(HotbarComponent.class);
  public static final ComponentMapper<HotbarUiComponent> hotbarUi =
      ComponentMapper.getFor(HotbarUiComponent.class);
  public static final ComponentMapper<InventoryUiComponent> inventoryUi =
      ComponentMapper.getFor(InventoryUiComponent.class);
  public static final ComponentMapper<SelectedHotbarItemComponent> selectedHotbarItem =
      ComponentMapper.getFor(SelectedHotbarItemComponent.class);
  public static final ComponentMapper<PrefabTypeComponent> prefabType =
      ComponentMapper.getFor(PrefabTypeComponent.class);
  public static final ComponentMapper<SelectedHotbarSlotComponent> selectedHotbarSlot =
      ComponentMapper.getFor(SelectedHotbarSlotComponent.class);
  public static final ComponentMapper<DamageComponent> damage =
      ComponentMapper.getFor(DamageComponent.class);
  public static final ComponentMapper<CurrentScreenComponent> currScreen =
