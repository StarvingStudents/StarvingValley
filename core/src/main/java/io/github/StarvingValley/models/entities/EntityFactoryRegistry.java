...
public class EntityFactoryRegistry {
    ...
    static {
        ...
        factories.put(PrefabType.WHEAT, () -> FoodItemFactory.createFoodItem(PrefabType.WHEAT, 10));
        factories.put(PrefabType.BEETROOT, () -> FoodItemFactory.createFoodItem(PrefabType.BEETROOT, 10));
    }
